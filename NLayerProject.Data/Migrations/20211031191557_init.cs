    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, null, false, "Pilot Kalem", 12.50m, 50 },
                    { 2, 1, null, false, "Kurşun Kalem", 20m, 50 },
                    { 3, 1, null, false, "Tükenmez Kalem", 30m, 50 },
                    { 4, 2, null, false, "Küçük Boy Defter", 40.50m, 50 },
                    { 5, 2, null, false, "Orta Boy Defter", 50.50m, 50 },
                    { 6, 2, null, false, "Büyük Boy Defter", 55.50m, 50 }
                });
